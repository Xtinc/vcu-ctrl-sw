...
int AL_H273_ColourDescToColourPrimaries(AL_EColourDescription colourDesc)
{
  ...
  case AL_COLOUR_DESC_MAX_ENUM: DBG_ASSERT_COND(0);
  }
...
{
  DBG_ASSERT_COND(eTransferCharacteristics != AL_TRANSFER_CHARAC_MAX_ENUM);
...
{
  DBG_ASSERT_COND(eColourMatrixCoef != AL_COLOUR_MAT_COEFF_MAX_ENUM);
